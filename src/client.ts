import { Authorization, Bearer, TwitterURL, APIURLType, APIRequest, APIRequestHeader, GuestToken } from "./mod.ts"
...
export class TwitterAPI {
    ...
    constructor(private _auth: Authorization = Bearer.Web, private _guestToken: GuestToken) {
        this.auth = _auth
